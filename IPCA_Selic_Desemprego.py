...
plt.plot(nucleo_ipca, color = "darkblue", label = "Núcleo IPCA 12 meses")
...
plt.annotate(f"{IPCA_mensal.iloc[-2,0]:.2f}%", xy=(IPCA_mensal.index[-2], IPCA_mensal.iloc[-2,0]), color = "blue", fontsize = 6, va = "top", ha = "center")
